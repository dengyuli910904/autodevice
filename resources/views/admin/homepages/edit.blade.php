...
@section('content')
    <div class="page-container">
        ...
        <form class="form form-horizontal" id="form-article-add" action="{{ url('admin/homepages/update') }}" method="POST">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">新闻编号：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ $data->news_uuid }}" name="news_uuid" id="news_uuid">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">链接路径：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ $data->url }}" name="url" id="url">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！">{{ $data->description}}</textarea>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  value="{{ $data->sort}}" name="sort" id="sort">
                </div>
            </div>
                <input type="hidden" name="cover" id="cover" value="{{ $data->cover}}">
                <input type="hidden" name="id" id="id" value="{{ $data->uuid}}">
