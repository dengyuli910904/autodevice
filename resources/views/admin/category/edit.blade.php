...
@section('content')
    <div class="page-container">
        ...
        <form class="form form-horizontal" id="form-article-add" action="{{ url('type/update') }}" method="POST">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ $data['type']->name }}" placeholder="类型名称" name="name" id="name">
                </div>
            </div>
            ...
            {{--<div class="row cl">--}}
                ...
                {{--<div class="formControls col-xs-8 col-sm-9">--}}
                    {{--<input type="text" class="input-text"  value="" name="order" id="order">--}}
                {{--</div>--}}
            {{--</div>--}}
