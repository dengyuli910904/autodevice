...
@section('content')
	...
	<form class="form form-horizontal" id="form-article-add" action="{{ url('jobs/store') }}" method="POST">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="" placeholder="" id="limit" name="limit">
			</div>
		</div>
        <div class="row cl">
