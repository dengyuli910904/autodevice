...
@section('content')
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 招聘管理 <span class="c-gray en">&gt;</span> 职位列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				...
				<a class="btn btn-primary radius" onclick="picture_add('新增','{{ url('jobs/create')}}' )" href="javascript:;">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td class="td-manage">
								...
								<a style="text-decoration:none" class="ml-5" onClick="picture_edit('编辑','{{ url('jobs/edit') }}','{{ $p->id }}')" href="javascript:;" title="编辑">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a> 
